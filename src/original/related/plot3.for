...
c-----------------------------------------------------------------------
      ...
      data      lin/3/,lout/4/
      character str*1024,str2*80,str3*80,str4*80
      integer   nsize
      ...
      write(lout,*)'%!'
      write(lout,*)
     +    'gsave 2.45 72 mul 7.3 72 mul translate 0.9 0.9 scale'
      nsize = 0
 ...
 90   continue
      ...
      write(lout,*)
     +    'gsave 2.45 72 mul 4.0 72 mul translate 0.9 0.9 scale'
      nsize = 0
 ...
 91   continue
      ...
      write(lout,*)
     +    'gsave 2.45 72 mul 0.75 72 mul translate 0.9 0.9 scale'
      nsize = 0
