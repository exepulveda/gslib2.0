...
c-----------------------------------------------------------------------
     ...
     +          str7*80,str8*80,str9*80
      ...
      write(lout,*)'%!'
      write(lout,*)
     +    'gsave 1.333 72 mul 7.95 72 mul translate 0.6667 0.6667',
     +      ' scale'
      nsize = 0
 ...
 91   continue
      ...
      write(lout,*)
     +    'gsave 1.333 72 mul 5.55 72 mul translate 0.6667 0.6667',
     +    ' scale'
      nsize = 0
 ...
 93   continue
      ...
      write(lout,*)
     +    'gsave 1.333 72 mul 3.15 72 mul translate 0.6667 0.6667',
     +            ' scale'
      nsize = 0
 ...
 95   continue
      ...
      open(lin,file=str7,status='OLD')
      write(lout,*)
     +    'gsave 1.333 72 mul 0.75 72 mul translate 0.6667 0.6667',
     +            ' scale'
      nsize = 0
 86   read(lin,*,end=96,err=99)
      nsize = nsize + 1
      go to 86
 96   continue
      rewind(lin)
